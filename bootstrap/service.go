...
var (
	// ErrClients indicates failure to communicate with mitras Clients service.
...
func New(policyService policies.Service, configs ConfigRepository, sdk mgsdk.SDK, encKey []byte, idp mitras.IDProvider) Service {
...
// Method client retrieves mitras Client creating one if an empty ID is passed.
