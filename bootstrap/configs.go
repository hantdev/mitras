...
// as well as info about corresponding mitras entities.
// MGClient represents corresponding mitras Client ID.
// MGKey is key of corresponding mitras Client.
// MGChannels is a list of mitras Channels corresponding mitras Client connects to.
type Config struct {
...
// Channel represents mitras channel corresponding mitras Client is connected to.
type Channel struct {
	ID          string                 `json:"id"`
	Name        string                 `json:"name,omitempty"`
...
//
//go:generate mockery --name ConfigRepository --output=./mocks --filename configs.go --quiet
