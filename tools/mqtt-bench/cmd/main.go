...
import (
	...
	bench "github.com/hantdev/mitras/tools/mqtt-bench"
...
func main() {
	...
	rootCmd.PersistentFlags().StringVarP(&bconf.Smq.ConnFile, "mitras", "m", "connections.toml", "config file for Mitras connections")
