// Package main contains e2e tool for testing Mitras.
package main

import (
	"log"

	"github.com/hantdev/mitras/tools/e2e"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "e2e",
		Short: "e2e is end-to-end testing tool for Mitras",
		Long: "Tool for testing end-to-end flow of mitras by doing a couple of operations namely:\n" +
	...
	// Root Flags
	rootCmd.PersistentFlags().StringVarP(&econf.Host, "host", "H", "localhost", "address for a running mitras instance")
