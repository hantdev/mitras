...
func TestCreateClient(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			domainID:    domainID,
			token:       validToken,
			authnRes:    mitrasauthn.Session{DomainUserID: domainID + "_" + validID, UserID: validID, DomainID: domainID},
...
func TestListClients(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			domainID: domainID,
			token:    validToken,
			authnRes: mitrasauthn.Session{UserID: validID, DomainID: domainID, DomainUserID: domainID + "_" + validID, SuperAdmin: false},
			status:   http.StatusOK,
			listClientsResponse: clients.ClientsPage{
				Page: clients.Page{
					Total: 1,
