...
var cmdJournal = cobra.Command{
	...
	Long: "Get journal\n" +
		"Usage:\n" +
		"\tmitras-cli journal get user <user_id> <user_auth_token> - lists user journal logs\n" +
		"\tmitras-cli journal get <entity_type> <entity_id> <domain_id> <user_auth_token> - lists entity journal logs\n" +
		"\tmitras-cli journal get <entity_type> <entity_id> <domain_id> <user_auth_token> --offset <offset> --limit <limit> - lists user journal logs with provided offset and limit\n",
