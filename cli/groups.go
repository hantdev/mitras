...
var cmdGroups = []cobra.Command{
	{
		...
		Long: "Creates new group\n" +
			"Usage:\n" +
			"\tmitras-cli groups create '{\"name\":\"new group\", \"description\":\"new group description\", \"metadata\":{\"key\": \"value\"}}' $DOMAINID $USERTOKEN\n",
	...
	},
	{
		...
		Long: "Updates group\n" +
			"Usage:\n" +
			"\tmitras-cli groups update '{\"id\":\"<group_id>\", \"name\":\"new group\", \"description\":\"new group description\", \"metadata\":{\"key\": \"value\"}}' $DOMAINID $USERTOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 3 {
				logUsageCmd(*cmd, cmd.Use)
				return
	...
	},
	{
		...
		Long: "Delete group by id.\n" +
			"Usage:\n" +
			"\tmitras-cli groups delete <group_id> $DOMAINID $USERTOKEN - delete the given group ID\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 3 {
				logUsageCmd(*cmd, cmd.Use)
				return
	...
	},
	{
		...
		Long: "Change group status to enabled\n" +
			"Usage:\n" +
			"\tmitras-cli groups enable <group_id> $DOMAINID $USERTOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 3 {
				logUsageCmd(*cmd, cmd.Use)
				return
	...
	},
	{
		...
		Long: "Change group status to disabled\n" +
			"Usage:\n" +
			"\tmitras-cli groups disable <group_id> $DOMAINID $USERTOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 3 {
				logUsageCmd(*cmd, cmd.Use)
				return
...
var cmdGroupsRoles = []cobra.Command{
	{
		...
		Long: "Create role\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles create <JSON_role> <group_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles create '{\"role_name\":\"admin\",\"optional_actions\":[\"read\",\"update\"]}' 4ef09eff-d500-4d56-b04f-d23a512d6f2a 39f97daf-d6b6-40f4-b229-2697be8006ef $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 4 {
				logUsageCmd(*cmd, cmd.Use)
				return
...

	{
		...
		Long: "Get group roles\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles get all <group_id> <domain_id> <user_auth_token> - lists all roles\n" +
			"\tmitras-cli groups roles get all <group_id> <domain_id> <user_auth_token> --offset <offset> --limit <limit> - lists all roles with provided offset and limit\n" +
			"\tmitras-cli groups roles get <role_id> <group_id> <domain_id> <user_auth_token> - shows role by role id and domain id\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 4 {
				logUsageCmd(*cmd, cmd.Use)
				return
...

	{
		...
		Long: "Update group role name\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles update <new_name> <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles update new_name 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 5 {
				logUsageCmd(*cmd, cmd.Use)
				return
...

	{
		...
		Long: "Delete group role\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles delete <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles delete 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 4 {
				logUsageCmd(*cmd, cmd.Use)
				return
...
var cmdGroupsActions = []cobra.Command{
	{
		...
		Long: "Add actions to role\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles actions add <JSON_actions> <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles actions add '{\"actions\":[\"read\",\"write\"]}' 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 5 {
				logUsageCmd(*cmd, cmd.Use)
				return
...

	{
		...
		Long: "List actions of role\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles actions list <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles actions list 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 4 {
				logUsageCmd(*cmd, cmd.Use)
				return
...

	{
		...
		Long: "Delete actions from role\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles actions delete <JSON_actions> <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"\tmitras-cli groups roles actions delete all <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles actions delete '{\"actions\":[\"read\",\"write\"]}' 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 5 {
				logUsageCmd(*cmd, cmd.Use)
				return
...

	{
		...
		Long: "List available actions\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles actions available-actions <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles actions available-actions 39f97daf-d6b6-40f4-b229-2697be8006ef $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 2 {
				logUsageCmd(*cmd, cmd.Use)
				return
...
var cmdGroupMembers = []cobra.Command{
	{
		...
		Long: "Add members to role\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles members add <JSON_members> <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles members add '{\"members\":[\"5dc1ce4b-7cc9-4f12-98a6-9d74cc4980bb\", \"5dc1ce4b-7cc9-4f12-98a6-9d74cc4980bb\"]}' 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 5 {
				logUsageCmd(*cmd, cmd.Use)
				return
...

	{
		...
		Long: "List members of role\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles members list <role_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles members list 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 4 {
				logUsageCmd(*cmd, cmd.Use)
				return
...

	{
		...
		Long: "Delete members from role\n" +
			"Usage:\n" +
			"\tmitras-cli groups roles members delete <JSON_members> <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"\tmitras-cli groups roles members delete all <role_id> <group_id> <domain_id> <user_auth_token>\n" +
			"For example:\n" +
			"\tmitras-cli groups roles members delete all 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n" +
			"\tmitras-cli groups roles members delete '{\"members\":[\"5dc1ce4b-7cc9-4f12-98a6-9d74cc4980bb\", \"5dc1ce4b-7cc9-4f12-98a6-9d74cc4980bb\"]}' 39f97daf-d6b6-40f4-b229-2697be8006ef 4ef09eff-d500-4d56-b04f-d23a512d6f2a 4ef09eff-d500-4d56-b04f-d23a512d6f2a $USER_AUTH_TOKEN\n",
		Run: func(cmd *cobra.Command, args []string) {
			if len(args) != 5 {
				logUsageCmd(*cmd, cmd.Use)
				return
