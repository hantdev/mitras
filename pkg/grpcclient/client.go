...
import (
	...
	grpcChannelsV1 "github.com/hantdev/athena/api/grpc/channels/v1"
	grpcClientsV1 "github.com/hantdev/athena/api/grpc/clients/v1"
	grpcDomainsV1 "github.com/hantdev/athena/api/grpc/domains/v1"
	grpcGroupsV1 "github.com/hantdev/athena/api/grpc/groups/v1"
	grpcTokenV1 "github.com/hantdev/athena/api/grpc/token/v1"
	tokengrpc "github.com/hantdev/athena/auth/api/grpc/token/"
	channelsgrpc "github.com/hantdev/athena/channels/api/grpc"
	clientsauth "github.com/hantdev/athena/clients/api/grpc"
	domainsgrpc "github.com/hantdev/athena/domains/api/grpc"
	groupsgrpc "github.com/hantdev/athena/groups/api/grpc"
