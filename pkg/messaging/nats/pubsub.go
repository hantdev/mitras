...
var (
	...
	jsStreamConfig = jetstream.StreamConfig{
		Name:              "channels",
		Description:       "Mitras stream for sending and receiving messages in between Mitras channels",
...
func (ps *pubsub) Subscribe(ctx context.Context, cfg messaging.SubscriberConfig) error {
	...
	consumerConfig := jetstream.ConsumerConfig{
		...
		Description:   fmt.Sprintf("Mitras consumer of id %s for cfg.Topic %s", cfg.ID, cfg.Topic),
