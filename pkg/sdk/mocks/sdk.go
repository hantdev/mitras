...
func (_mock *SDK) IssueCert(ctx context.Context, clientID string, validity string, domainID string, token string) (sdk.Cert, errors.SDKError) {
...
func (_c *SDK_IssueCert_Call) RunAndReturn(run func(ctx context.Context, clientID string, validity string, domainID string, token string) (sdk.Cert, errors.SDKError)) *SDK_IssueCert_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *SDK_ViewCert_Call) RunAndReturn(run func(ctx context.Context, certID string, domainID string, token string) (sdk.Cert, errors.SDKError)) *SDK_ViewCert_Call {
	_c.Call.Return(run)
	return _c
}

// ViewCertByClient provides a mock function for the type SDK
func (_mock *SDK) ViewCertByClient(ctx context.Context, clientID string, domainID string, token string) (sdk.CertSerials, errors.SDKError) {
	ret := _mock.Called(ctx, clientID, domainID, token)
...
func (_c *SDK_ViewCertByClient_Call) RunAndReturn(run func(ctx context.Context, clientID string, domainID string, token string) (sdk.CertSerials, errors.SDKError)) *SDK_ViewCertByClient_Call {
	_c.Call.Return(run)
	return _c
}
